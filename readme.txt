The code contains a scheduled task (./dags/auto_retrain_dag.py) in AirFlow. It runs each 45 mins or you can trigger it manually. How to use a simple branching logic in DAG is also presented.
...
4. After being able to log on, you can see the "auto_retrain_model_dag" and you can trigger it manually in the upper right corner, or wait for a trigger in every 45 mins. You can change the schedule and the DAG graph in ./dags/auto_retrain_dag.py.
